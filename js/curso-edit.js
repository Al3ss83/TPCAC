...
createApp({
  data() {
    return {
      ...
      nivel: "",
      docente: 0,
      url: "https://equipow23.pythonanywhere.com/cursos/" + id,
    };
  },
  methods: {
    fetchData(url) {
      ...
      */
      fetch(url)
        ...
        .then((data) => {
          ...
          this.modalidad_cursada = data.modalidad_cursada;
          this.duracion_curso = data.duracion_curso;
